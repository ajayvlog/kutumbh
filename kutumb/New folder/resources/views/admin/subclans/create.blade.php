        ...
        <main>
            <div class="container-fluid">
                ...
                <div class="card mb-4">
                    ...
                    @endif
                    <div class="card-body">
                        <form action="{{ route('admin.subclans.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="subclan_name" class="form-control" placeholder="Enter Subclan Name" style="width:500px">
                            </div>
