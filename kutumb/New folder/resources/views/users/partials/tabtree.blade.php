                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <span class="{{($l->gender_id==2)?'female':'male'}}">
                                                    <a href="http://192.168.0.27:8000/users/{{$l->id}}" title="{{($l->gender_id==2)?'Sister':'Brother'}} {{$l->name}} ({{($l->gender_id==2)?'F':'M'}})">
                                                        <span class="img-gender"><img src="http://192.168.0.27:8000/images/icon_user_new_{{($l->gender_id==2)?'2':'1'}}.png"></span>
