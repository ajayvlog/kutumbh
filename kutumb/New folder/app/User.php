...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        ...
        'email', 'password',
        'address', 'phone',
        'dob', 'yob','pob','tob', 'dod', 'yod',
        'father_id', 'mother_id', 'parent_id',
        'relign_id', 'cast_id', 'dynasty_id','dynasty_other','subclan_other','clan_other',
        'clan_id', 'subclan_id', 'country_id',
        'state_id', 'city_id', 'tehsil_id', 'village_id',
    ];
    ...
    //Relations with master table start
    public function religion() {
        return $this->belongsTo(Religion::class, 'relign_id');
    }
    public function cast() {
        return $this->belongsTo(Cast::class, 'cast_id');
    }
    public function dynasty() {
        return $this->belongsTo(Dynastie::class, 'dynasty_id');
    }
    public function clan() {
        return $this->belongsTo(Clan::class, 'clan_id');
    }
    public function subclan() {
        return $this->belongsTo(Subclan::class, 'subclan_id');
    }
    ...
    //Relations with master table end
    ...
    {
        return $this->hasMany(User::class, 'id', 'father_id')->with('parents')->orderBy('created_at', 'DESC');
    }
