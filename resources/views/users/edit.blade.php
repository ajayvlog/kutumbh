...
@endif
                            ...
                            <div class="form-group">
                                ...
                                <select name="dynasty_id" class="form-control select22" id="dynasty">
                                    ...
                                    @foreach ($dynasties as $key => $value)
                                        ...
                                        @if($loop->last)
                                        <option value="-1" {{ -1 == $user->dynasty_id ? 'selected':'' }}>Others</option>
                                        @endif
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="clan_id" class="form-control select22">
                                    ...
                                    @foreach ($clans as $key => $value)
                                        ...
                                        @if($loop->last)
                                        <option value="-1" {{ -1 == $user->clan_id ? 'selected':'' }}>Others</option>
                                        @endif
                                        @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="subclan_id" id="subclan_id" class="form-control select22">
                                    <option value="">--- Select Sub-Gotra ---</option>
                                        ...
                                        @if($loop->last)
                                        <option value="-1" {{ -1 == $user->subclan_id ? 'selected':'' }}>Others</option>
                                        @endif
                                        @endforeach ---}}
                                        <option value="-1" {{ -1 == $user->subclan_id ? 'selected':'' }}>Others</option>
        ...
        <div class="mb-2 text-dark col-3 border pt-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! FormField::file('photo', ['req
                        uired' => true, 'label' => __('user.reupload_photo'), 'info' => ['text' => 'Format jpg, maks: 200 Kb.', 'class' => 'warning']]) !!}
                </div>
