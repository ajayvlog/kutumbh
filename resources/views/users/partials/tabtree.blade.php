                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <span class="{{($l->gender_id==2)?'female':'male'}}">
                                                    <a href="{{ route('users.show',[$l->id]) }}" title="{{($l->gender_id==2)?'Sister':'Brother'}} {{$l->name}} ({{($l->gender_id==2)?'F':'M'}})">
                                           ...
                                           <?php 
                                            ...
                                            ?> 
                                               ...
                                               @if($f && $l->gender_id==2)
                                                    <span class="male">
                                                        <a href="{{ route('users.show',[$f->id]) }}" title="{{'Brother in law '. $f->name.' (M)' }}">
                                                            <span class="img-gender">{{ userPhoto($parent, ['class' => '']) }}</span>
                                                            <span class="name"> {{ $f->name??'' }} </span>
                                                            <span class="gender">{{ $f->gender_id==1?'M':'F' }}</span>
                                                        </a>
                                                    </span> 
                                                 @endif 
                                                 ...
                                                 @if($m && $l->gender_id==1)
                                                    <span class="female">
                                                                    <a href="{{ route('users.show',[$m->id]) }}" title="{{' Bhabhi '. $m->name.' (F)' }}">                                            
                                                                        <span class="img-gender">{{ userPhoto($wife, ['class' => '']) }}</span>
                                                                        <span class="name">{{ $m->name??'' }}</span>
                                                                        <span class="gender">{{ $f->gender_id==1?'M':'F' }}</span>
                                                                    </a>
