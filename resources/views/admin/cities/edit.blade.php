                            ...
                            <div class="form-group">
                                ...
                                <select name="state_id" class="form-control" style="width:500px">
                                    ...
                                    @foreach ($states as $key => $value)
                                        <option value="{{ $key }}" {{ $key == $city->state_id ? 'selected':'' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                <strong>City Name:</strong>
                                <input type="text" name="city_name" value="{{ $city->city_name }}" class="form-control" placeholder="Enter City Name" style="width:500px">
                            </div>
